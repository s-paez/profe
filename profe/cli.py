...
def print_manual():
    ...
    \033[1mOPTIONS:\033[0m
        \033[1m-p, --preprocess\033[0m
            ...
            files by type (Bias, Dark, Flat, Light), creates a summary.dat,
...
def main() -> None:
    # Intercept 'man' argument early because argparse handles positional args uniquely
    ...
    # Make sure -n is only used with -p
    if args.output and args.cores is not None:
        parser.error("-n/--cores can only be used with the preprocessing (-p) step.")
